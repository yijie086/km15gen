...
# Marc's paper has a different spence function definition. spence(z) here is spence(1-z) in Marc's paper
# See https://docs.scipy.org/doc/scipy/reference/generated/scipy.special.spence.html
